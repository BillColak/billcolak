    ...
    return (
        <div className="container h-screen" >
            <svg className="milk-404 h-screen" viewBox="0 0 500 500">
                ...
                <g id="milk-face">
                    <path id="mouth" fill="none" stroke="#4f3e7c" strokeLinecap="round" strokeMiterlimit="10"
                    ...
                    <path className={'hidden'} id="mouth-frown" fill="none" stroke="#4f3e7c" strokeLinecap="round" strokeMiterlimit="10"
