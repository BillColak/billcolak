...
const Page404 = () => {
    ...
    //
    // // Mouth
    let frown = 'M368.4 240.8s-15.4-10.5-27.3 3.5';
    let mouth = 'M338.4 239.8l32-3.9';
    //
    ...
    useEffect(() => {
        const mouth = document.getElementById('#mouth-frown');
        console.log(mouth)
    }, []);
    ...
    return (
        <div className="container h-screen" >
            <svg className="milk-404 h-screen" viewBox="0 0 500 500">
                ...
                <g id="milk-container">
                    ...
                    <path fill="#6366f1" // top of the box
                ...
                <g id="web-page">
                    ...
                    <path fill="#818cf8" d="M399.1 184.8l-92.3 10.5V188l92.3-10.5v1.5z"/>
                    <path fill="#fff"
                ...
                <g id="milk-face">
                    <path id="mouth" fill="none" stroke="#4f46e5" strokeLinecap="round" strokeMiterlimit="10"
                          strokeWidth="4" d="M338.4 239.8l32-3.9"/>
                    {/*<path id="mouth-smile" fill="none" stroke="#4f46e5" stroke-linecap="round" stroke-miterlimit="10" stroke-width="4" d="M341.1 240.5s15.4 10.5 27.3-3.5"/> */}
                    <path className={'hidden'} id="mouth-frown" fill="none" stroke="#4f46e5" strokeLinecap="round" strokeMiterlimit="10"
                          strokeWidth="4" d="M368.4 240.8s-15.4-10.5-27.3 3.5"/>
                    <g id="eyes">
                        <circle id="eye-right-open" cx="375.3" cy="215.6" r="5" fill="#4f46e5"/>
                        <circle id="eye-left-open" cx="330.9" cy="220" r="5" fill="#4f46e5"/>
                    </g>
                    {/*#eyes*/}
                </g>
                 {/*#milk-face*/}
